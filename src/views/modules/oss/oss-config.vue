    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="120px">
      <el-form-item size="mini" label="存储类型">
        <el-radio-group v-model="dataForm.type">
          ...
          <el-radio :label="4">本地vsftp</el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <template v-else-if="dataForm.type === 4">
        <el-form-item label="Host地址">
          <el-input v-model="dataForm.vsftpHost" placeholder="上传服务器地址域名"></el-input>
        </el-form-item>
        <el-form-item label="Root目录">
          <el-input v-model="dataForm.vsftpRootDir" placeholder="上传的根目录地址"></el-input>
        </el-form-item>
        <el-form-item label="访问域名">
          <el-input v-model="dataForm.vsftpVisitDomain" placeholder="文件访问域名"></el-input>
        </el-form-item>
        <el-form-item label="存放目录">
          <el-input v-model="dataForm.vsftpSourceDir" placeholder="上传的存放目录(有具体业务填默认)"></el-input>
        </el-form-item>
        <el-form-item label="访问目录">
          <el-input v-model="dataForm.vsftpWebUrl" placeholder="文件访问目录(有具体业务填default)"></el-input>
        </el-form-item>
        <el-form-item label="用户名">
          <el-input v-model="dataForm.vsftpUsername" placeholder="vsftp用户名"></el-input>
        </el-form-item>
        <el-form-item label="密码">
          <el-input v-model="dataForm.vsftpPassword" placeholder="vsftp密码"></el-input>
        </el-form-item>
        <el-form-item label="端口">
          <el-input v-model="dataForm.vsftpPort" placeholder="vsftp端口"></el-input>
        </el-form-item>
      </template>
    </el-form>
