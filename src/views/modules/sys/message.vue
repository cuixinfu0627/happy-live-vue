  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('sys:message:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.fromType===1">所有人</el-tag>
          <el-tag type="warning" v-else-if="scope.row.fromType===2">管理人员</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="fromNickName"
      ...
      <el-table-column
        ...
        label="用户组">
        <template slot-scope="scope">
          <el-tag type="success" v-if="scope.row.groupType===1">所有人</el-tag>
          <el-tag type="warning" v-else-if="scope.row.groupType===2">其他用户</el-tag>
        </template>
      </el-table-column>
      <el-table-column
        prop="type"
        ...
        <template slot-scope="scope">
          ...
          <el-tag type="warning" v-else-if="scope.row.type===2">系统消息</el-tag>
